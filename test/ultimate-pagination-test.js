...
describe('getPaginationModel', function() {
  it('should return [1, 2, 3, 4, "...", 10] for 1 of 10', function(){
    expect(getPaginationModel(1, 10)).toEqual([1, 2, 3, 4, '...', 10]);
  });

  it('should return [1, 2, 3, 4, "...", 10] for 2 of 10', function(){
    expect(getPaginationModel(2, 10)).toEqual([1, 2, 3, 4, '...', 10]);
  });
  ...
  it('should return [1, "...", 7, 8, 9, 10] for 8 of 10', function(){
    expect(getPaginationModel(8, 10)).toEqual([1, '...', 7, 8, 9, 10]);
  });

  it('should return [1, "...", 7, 8, 9, 10] for 9 of 10', function(){
    expect(getPaginationModel(9, 10)).toEqual([1, '...', 7, 8, 9, 10]);
  });

  it('should return [1, "...", 7, 8, 9, 10] for 10 of 10', function(){
    expect(getPaginationModel(10, 10)).toEqual([1, '...', 7, 8, 9, 10]);
  });
});
